...
// Set alert view only completion block
+ (instancetype)showWithTextFieldTitle:(NSString *)title message:(NSString *)message buttons:(NSArray *)buttons completion:(void(^)(NSUInteger btn, NSString *text))completion;
